/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime false` (hash: ca618e8751ca4ee8da76d6a25479edc5)
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/_worker");
		durableNamespaces: "RenovationAgent" | "EstimateCollabHub" | "GAS_A2A";
	}
	interface Env {
		CACHE: KVNamespace;
