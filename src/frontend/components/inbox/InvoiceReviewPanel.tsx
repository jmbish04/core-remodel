    ...
    <Card className={isConfirmed ? "border-green-500/50" : ""}>
      ...
      <CardContent>
        ...
        {invoice.lineItems?.length > 0 && (
          <div className="mb-4">
            <Label className="mb-2 block">Line Items ({invoice.lineItems.length})</Label>
            <div className="border rounded-md divide-y overflow-hidden">
              ...
              {invoice.lineItems.map((li: any) => (
                <div key={li.id} className="grid grid-cols-12 gap-2 p-2 text-sm items-center">
                  ...
                  {/* Future: Add dropdown for matching to material_schedule_items here */}
                </div>
              ))}
            </div>
          </div>
