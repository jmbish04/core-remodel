...
export const NAV_GROUPS: NavGroupDef[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/plan/3d", label: "Layout Studio" },
    ...
    items: [
      { href: "/admin/shopping", label: "Sourcing Tools", icon: ClipboardCheck },
      {
        ...
        children: [
          ...
          { href: "/admin/shopping/showrooms/finder", label: "Finder", icon: Search },
          { href: "/admin/shopping/showrooms/exclusions", label: "Not interested", icon: Ban },
