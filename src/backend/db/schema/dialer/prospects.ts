 ...
 * lives in dialer_prospect_state (1:1).
 */
export const dialerProspects = sqliteTable("dialer_prospects", {
  ...
  // Permit-derived identity & address signals (populated by seed + enrichment)
  licenseNo: text("license_no"),
  distinctLicenses: integer("distinct_licenses"),
  distinctFirms: integer("distinct_firms"),
  distinctZips: integer("distinct_zips"),
