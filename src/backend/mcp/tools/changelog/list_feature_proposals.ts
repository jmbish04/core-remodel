  ...
  outputShape: {
    ...
    proposals: z.array(
      looseObject({
        ...
        contextSize: z.string().describe("Human-readable transcript size, e.g. '439.5 KB'"),
        coverageNote: z.string().nullable().describe("What the transcript does and does not cover"),
        url: urlField,
      }),
    ),
  },
