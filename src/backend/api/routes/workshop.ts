...
// ─────────────────────────────────────────────────────────────────────────────
// POST /nodes/:id/recipe — extract | material-swap | mix |// material-swap | clay-to-photoreal | floor-plan-furnish | tone-unify | lighting-enhance — single-image| floor-plan-furnish | tone-unify | lighting-enhance
// ─────────────────────────────────────────────────────────────────────────────
...
const RecipeRequestSchema = z.discriminatedUnion("recipe", [
  ...
  z.object({ recipe: z.literal("tone-unify"), params: RecipeFloorPlanFurnishParams }),
  z.object({ recipe: z.literal("lighting-enhance"), params: RecipeFloorPlanFurnishParams }),
]);
