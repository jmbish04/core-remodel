...
| `/admin/changelog/preview/[slug]` | `src/frontend/pages/admin/changelog/preview/[slug].astro` | Astro.locals Middleware |
...
| `/admin/plan/3d` | `src/frontend/pages/admin/plan/3d.astro` | Astro.locals Middleware |
...
| `/floor-plan` | `src/frontend/pages/floor-plan.astro` | Astro.locals Middleware |
...
| `/questionnaire` | `src/frontend/pages/questionnaire/index.astro` | Astro.locals Middleware |
| `/questionnaire/[section_slug]` | `src/frontend/pages/questionnaire/[section_slug].astro` | None (Astro Frontmatter) |
| `/questionnaire/print` | `src/frontend/pages/questionnaire/print.astro` | Astro.locals Middleware |
| `/rooms/[slug]` | `src/frontend/pages/rooms/[slug].astro` | Astro.locals Middleware |
...
| `/studio-runtime` | `src/frontend/pages/studio-runtime.astro` | Astro.locals Middleware |
