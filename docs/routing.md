...
This project uses Astro's file-based routing. Routes map URL paths to the corresponding `.astro` components located in `src/frontend/pages/`.

Note that there are no explicit route guards defined within the frontend pages based on `Astro.cookies` or `requireAccessAuth` queries. Access control is managed in the backend API layer and `_worker.ts`.
...
| `/admin/blank-canvas/[...tab]` | `src/frontend/pages/admin/blank-canvas/[...tab].astro` | None (Astro Frontmatter) |
| `/admin/brands` | `src/frontend/pages/admin/brands.astro` | None (Astro Frontmatter) |
| `/admin/brands/[id]` | `src/frontend/pages/admin/brands/[id].astro` | None (Astro Frontmatter) |
| `/admin/budget/dashboard` | `src/frontend/pages/admin/budget/dashboard.astro` | None (Astro Frontmatter) |
| `/admin/budget/grid` | `src/frontend/pages/admin/budget/grid.astro` | None (Astro Frontmatter) |
...
| `/admin/config/budget/phases` | `src/frontend/pages/admin/config/budget/phases.astro` | None (Astro Frontmatter) |
...
| `/admin/render/campaigns` | `src/frontend/pages/admin/render/campaigns.astro` | None (Astro Frontmatter) |
| `/admin/render/campaigns/[id]` | `src/frontend/pages/admin/render/campaigns/[id].astro` | None (Astro Frontmatter) |
...
| `/sitemap.json` | `src/frontend/pages/sitemap.json.ts` | None (Astro Frontmatter) |
| `/sitemap.xml` | `src/frontend/pages/sitemap.xml.ts` | None (Astro Frontmatter) |
