JULES: This is the prompt copied from `docs/context/builder_checklists/prompt_checklist_ux_discovery.md` ... based on your research in this session, your task is to annotate this prompt to include refinements that will improve the efficacy of the coding agent that will be assigned this prompt with technical implementation details, etc and also that will further expand on and improve the stitch ux discovery workshop process to fully maximize the ux and user journeys.
