...
tables: 
    - estimate: (id auto pk, timestamp created, timestamp last modified, estimate_status_id (negotiating, acccepted, etc), estimate_company_id (fk)
