// Hand-picked Lucide-style icon set. Stroke-based, 24px grid, 1.5 stroke.
// Exposed as <Icon name="..." size={16} className="..." />
const ICON_PATHS = {
  ...
  "arrow-down": <><path d="M19 12l-7 7-7-7"/><path d="M12 5v14"/></>,
  ...
  hammer: <path d="m15 12-8.5 8.5a2.12 2.12 0 1 1-3-3L12 9m1 6 6-6 .5.5a3.5 3.5 0 0 0 5-5l-4 4-2-2 4-4a3.5 3.5 0 0 0-5 5L13 9"/>,
  ...
  archive: <><polyline points="21 8 21 21 3 21 3 8"/><rect x="1" y="3" width="22" height="5"/><line x1="10" x2="14" y1="12" y2="12"/></>,
  send: <><line x1="22" x2="11" y1="2" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></>,
  database: <><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></>,
  cpu: <><rect x="4" y="4" width="16" height="16" rx="2" ry="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" x2="9" y1="2" y2="4"/><line x1="15" x2="15" y1="2" y2="4"/><line x1="9" x2="9" y1="20" y2="22"/><line x1="15" x2="15" y1="20" y2="22"/><line x1="20" x2="22" y1="9" y2="9"/><line x1="20" x2="22" y1="15" y2="15"/><line x1="2" x2="4" y1="9" y2="9"/><line x1="2" x2="4" y1="15" y2="15"/></>,
};

function Icon({ name, size = 16, className = "", strokeWidth = 1.5 }) {
  const paths = ICON_PATHS[name];
  if (!paths) return <span className="inline-block" style={{width: size, height: size}}></span>;
  return (
    <svg
